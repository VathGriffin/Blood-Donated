...
import {
  Dashboard, PeopleAlt, LocalHospital, Inventory2,
  CalendarMonth, Chat, ArrowBack, Favorite,
    ...
    >
      ...
      <Box sx={{ px: 3, pt: 11, pb: 3, borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
          ...
          <Box>
            <Typography fontWeight={800} fontSize="1rem" color="white" lineHeight={1.2}>
              Blood Donated
            </Typography>
          ...
          {navItems.map((item) => {
            ...
            return (
              <ListItemButton
                ...
                selected={isSelected}
                sx={{
                  borderRadius: 2.5, mb: 0.5, py: 1.3, px: 1.5,
              ...
              >
                ...
                />
                {isSelected && (
                  <Box sx={{ width: 6, height: 6, borderRadius: '50%', bgcolor: '#ffcdd2' }} />
                )}
              </ListItemButton>
            );
          })}
      ...
      <Box sx={{ borderTop: '1px solid rgba(255,255,255,0.08)', p: 2 }}>
        <Button
          ...
          sx={{
            ...
            '&:hover': { backgroundColor: 'rgba(255,255,255,0.1)', color: 'white', borderColor: 'rgba(255,255,255,0.3)' },
          }}
        >
          Back to Website
        </Button>
