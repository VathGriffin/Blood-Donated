    ...
    return (
      ...
      >
        ...
        <Box sx={{ display: "flex", gap: 2 }}>
          <Button variant="contained" color="error" component={Link} href="/login" sx={{ borderRadius: 3 }}>
            Log In
          </Button>
          <Button variant="outlined" color="error" component={Link} href="/register" sx={{ borderRadius: 3 }}>
            Sign Up
          </Button>
        </Box>
      </Box>
