          ...
          <Box sx={{ display: "flex", flexDirection: { xs: "column", md: "row" }, alignItems: "center", gap: 6 }}>
            ...
            <Box flex={1} data-aos="fade-right">
              ...
              <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap", mb: 5 }}>
                <Button
                  variant="contained" size="large" component={RouterLink} to="/donate"
                  sx={{
                ...
                <Button
                  variant="outlined" size="large" component={RouterLink} to="/request"
                  sx={{
            ...
            <Box data-aos="fade-left" sx={{
              ...
              <Button
                fullWidth component={RouterLink} to="/appointment" variant="contained"
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "repeat(3, 1fr)" }, gap: 4 }}>
            {features.map((item, idx) => (
              <Card key={idx} data-aos="fade-up" data-aos-delay={idx * 100} sx={{
                ...
                <Button variant="contained" color="error" size="small" component={RouterLink} to={item.link} sx={{ borderRadius: 3, px: 3 }}>
                  {item.label}
                </Button>
              </Card>
            ))}
      ...
      <Box sx={{
        ...
        <Container maxWidth="md" sx={{ position: "relative", zIndex: 1 }}>
          ...
          <Box sx={{ display: "flex", justifyContent: "center", gap: 2.5, flexWrap: "wrap" }}>
            <Button variant="contained" size="large" component={RouterLink} to="/donate" sx={{
            ...
            <Button variant="outlined" size="large" component={RouterLink} to="/appointment" sx={{
