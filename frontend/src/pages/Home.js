...
const Home = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 10, mb: 8 }}>
      {/* Hero Section */}
      <Box textAlign="center" mb={10} data-aos="fade-down">
        <Typography
          variant="h3"
          component="h1"
          gutterBottom
      ...
      {/* Banner Image with full display */}
      <Box
      ...
      >
        ...
        <DialogContent>
          <Typography
            variant="body1"
            sx={{ lineHeight: 1.8, color: "#444", mb: 2 }}
          >
            This image represents the joy and connection among volunteers and
            donors.
          </Typography>

          <Typography
            variant="subtitle1"
            sx={{ fontWeight: 600, color: "#b71c1c", mt: 2 }}
          >
            🩸 Why Donate Blood?
          </Typography>
          <Typography
          ...
          <Typography
            variant="subtitle1"
            sx={{ fontWeight: 600, color: "#b71c1c", mt: 3 }}
          >
            ✅ Who Can Donate?
          </Typography>
          <Typography variant="body2" sx={{ lineHeight: 1.7, color: "#555" }}>
            Most healthy adults between 18–60 years old who weigh at least 45kg
            can donate. It’s safe, simple, and only takes about 15 minutes.
          </Typography>
